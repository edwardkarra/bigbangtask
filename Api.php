...
class Api
{
    //EVERY ADDED BLOCK IS NOTED WITH : edited by EDWARD KARRA for BIGBANG TASK

    // edited by EDWARD KARRA for BIGBANG TASK
    protected $special_allow = false ;
    // edited by EDWARD KARRA for BIGBANG TASK
    ...
    public function handleRequest($request = null)
    {
        ...
        // edited by EDWARD KARRA for BIGBANG TASK
            ...
            //check if request trying to access Currencies Entity
        $my_resource = $this->request->getResource();
        if($my_resource === 'currencies'){
            //passing through authentication by declaring $special_allow Var
            $this->special_allow = true;
            $authorized = true;
        }
        // edited by EDWARD KARRA for BIGBANG TASK
    ...
    protected function authenticate()
    {
        // edited by EDWARD KARRA for BIGBANG TASK
            ...
            //passing Authenticate function
        if($this->special_allow){
            return true;
        }
        // edited by EDWARD KARRA for BIGBANG TASK
...
//            var_dump($accepted_params[0]->name);
//            die();
